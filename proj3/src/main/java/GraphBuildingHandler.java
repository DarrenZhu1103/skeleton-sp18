...
//            System.out.println("Beginning a way...");
            ...
            nodeList.add(Long.parseLong(attributes.getValue("ref")));
...
//            System.out.println("Finishing a way...");
            if (validWay){
                long node = nodeList.remove();
                long next;
                while (!nodeList.isEmpty()){
                    next = nodeList.remove();
                    g.getNode(node).addNode(next);
                    g.getNode(next).addNode(node);
                    node = next;
                }
            }
            validWay = false;
